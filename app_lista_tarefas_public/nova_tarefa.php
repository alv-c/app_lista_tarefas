...
<body>
	...
	<div class="container app">
		<?php if (isset($_GET['inclusao']) && (bool)$_GET['inclusao']) : ?>
			<div class="alert alert-success alert-dismissible fade show" role="alert">
				Tarefa inserida com <strong>sucesso!</strong>
				...
				<div class="container pagina">
					<div class="row">
						<div class="col">
							<h4>Nova tarefa</h4>
							<hr />
							<form method="post" action="/app_lista_tarefas_public/tarefa.controller.php?acao=inserir">
